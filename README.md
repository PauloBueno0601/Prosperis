...
:página_virada_para_cima: Arquivos Importantes <br>
- <b>.gitignore</b>: Arquivo que especifica quais arquivos/pastas devem ser ignorados pelo Git.
- <b>.env</b>: Exemplo de arquivo para definir variáveis de ambiente do projeto.
